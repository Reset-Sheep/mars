  ...
  <div class="bg-[#000]">
    ...
    <div class="h-[85vh] w-full relative">
      <div>
        ...
        <div class="huachenyu-text text-[#fff] text-[2.7vw] top-[80px] right-[20px]">
        ...
        <div class="huachenyu-text text-[#ff8331] text-[3.7vw] top-[150px] right-[20px]">
          【2024】举办万人海边日出演唱会
        </div>
        <div class="huachenyu-text text-[#ff8331] text-[2.7vw] top-[230px]">
          【2014】首登央视春晚舞台
        </div>
        <div class="huachenyu-text text-[#ff8331] text-[2.5vw] top-[300px] w-[26vw]">
          【2016】亚洲新歌榜最佳男歌手奖
        </div>
      </div>
      <div>
    ...
    <div>
      <img src="@/assets/img/divider.png" alt="" class="w-full" />
    </div>
    <div class="h-[80vh] overflow-x-hidden bg-[url('@/assets/img/fangge.jpg')] pt-[50px]">
    ...
    <div class="w-full bg-[#141415]">
      <div class="w-full flex justify-center pt-[200px] pb-[100px]">
        <!-- <Novel></Novel> -->
        <Modeling />
      </div>
    </div>
    ...
    <ClientOnly>
      <div class="relative w-full overflow-hidden rounded-lg">
        <div>
          <img src="@/assets/img/world.png" class="w-[30vw] animate-spin slow-spin" alt="" />
        </div>
        <!-- <FlickeringGrid
          class="relative inset-0 z-0 [mask-image:radial-gradient(450px_circle_at_center,white,transparent)]"
          :square-size="4" :grid-gap="6" color="#60A5FA" :max-opacity="0.5" :flicker-chance="0.1" :width="2000"
          :height="800" /> -->
      </div>
    </ClientOnly>
